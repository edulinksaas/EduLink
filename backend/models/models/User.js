...
export class User {
  ...
  async save() {
    ...
    try {
      ...
      // undefined가 아닌 경우에만 포함하여 컬럼이 없어도 에러가 나지 않도록 함
      if (this.email_verified !== undefined && this.email_verified !== null) {
        userData.email_verified = this.email_verified;
      }
      if (this.verification_token !== undefined && this.verification_token !== null) {
        userData.verification_token = this.verification_token;
      }
      if (this.verification_token_expires_at !== undefined && this.verification_token_expires_at !== null) {
